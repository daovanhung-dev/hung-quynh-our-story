...
@Component({
  ...
  styles: [`
    ...
    .back { display: inline-flex; margin-bottom: 4rem; color: var(--text-secondary); text-decoration: none; }
    header { max-width: 840px; margin-bottom: 3rem; }
    time, .location { color: var(--text-muted); font-size: .86rem; }
    h1 { margin: .6rem 0 1.2rem; font-family: var(--font-display); font-size: clamp(3rem, 8vw, 7rem); line-height: .93; letter-spacing: -.05em; }
